...
export class Matrix4 {
  ...
  compose(position: Vector3, rotation: Vector3, scale: Vector3): Matrix4 {
    ...
    this.copy(t).multiply(r).multiply(s);
    return this;
  }

  perspective(fovRad: number, aspect: number, near: number, far: number): Matrix4 {
